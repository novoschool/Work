namespace Sorting
{
    internal class Program
    {
        ...
        private static void SingleComplexKeyValueSort(Action<IList<ComplexKeyValue>, Func<ComplexKeyValue, ComplexKeyValue, int>> sort, 
        ...
        static void ShowArray(ComplexKeyValue[] array)
        {
            ...
            foreach (var item in array)
            {
                ...
                if (++count >= 10 && item.Key1 != prevKey1 && item.Key2 != prevKey2)
                {
                    Console.WriteLine();
                    count = 0;
                }
